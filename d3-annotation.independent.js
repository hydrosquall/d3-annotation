(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-drag'), require('d3-shape'), require('clipboard-copy'), require('d3-dispatch')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-selection', 'd3-drag', 'd3-shape', 'clipboard-copy', 'd3-dispatch'], factory) :
	(factory((global.d3annotation = global.d3annotation || {}),global.d3,global.d3,global.d3,global.clipboardCopy,global.d3));
}(this, (function (exports,d3Selection,d3Drag,d3Shape,clipboardCopy,d3Dispatch) { 'use strict';

clipboardCopy = 'default' in clipboardCopy ? clipboardCopy['default'] : clipboardCopy;
...
function annotation() {
  ...
  annotation.json = function () {
    ...
    clipboardCopy(JSON.stringify(collection.json.map(function (a) {
      delete a.type;
      return a;
    })));
    return annotation;
